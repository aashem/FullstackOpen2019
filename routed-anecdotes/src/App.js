        ...
        <Notification/>
          ...
          <div>
            ...
            <Link style={padding} to ='/about'>about</Link>
              ...
              <Route path='/create' render ={() => <CreateNew anecdotes={anecdotes} addNew = {addNew} redirect = {redirect} setRedirect={setRedirect} setNotification = {setNotification}/> } />      
              <Route path='/about' render ={() => <About/> } />  
              <Route path='/:id' render ={({match}) => <Anecdote anecdote={anecdoteById(match.params.id)}/> }/>    
          </div>
        </Router> 
      </div>
    )
